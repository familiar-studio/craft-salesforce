...
class SalesforceSandbox extends BaseProvider
{
    // Public Methods
    // =========================================================================
    ...
    {
      return UrlHelper::getResourceUrl('salesforce/icon-sandbox.svg');
    ...
    {
        return 'https://cs1.salesforce.com/02u?retURL=%2Fui%2Fsetup%2FSetup%3Fsetupid%3DDevTools&setupid=TabSet';
    }
    ...
    public function createProvider()
    {
        ...
        return new \Dukt\OAuth\OAuth2\Client\Provider\SalesforceSandbox($config);
    }
